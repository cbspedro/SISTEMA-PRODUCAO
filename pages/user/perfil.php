   ...
   <div class="row">
      <div class="col-md-4" style="margin-top: 20px">
         <div class="card card-profile">
            <img src="../../assets/img/bguser<?php echo $cont ["id"] ?>.jpg" alt="Image placeholder" class="card-img-top">
            ...
            <div class="card-body pt-0">
               ...
               <div class="text-center mt-4">
                  <h5>
                     <?php echo $cont ["username"] ?><span class="font-weight-light"></span>
                  </h5>
      ...
      <div class="col-md-8"style="margin-top: 20px">
          ...
          <div class="card">
            <form action="editcliente.php" method="GET">
            <div class="card-header pb-0">
              <p class="text-uppercase text-sm">Informação do cliente 
                ...
                <?php
  if ($adm == "1") {
    echo '<input type="submit" style="float:right;" class="btn btn-primary btn-sm ms-auto" value="Editar"></input></p>';
  }
?>
              ...
              <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["nome"] ?>">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="example-text-ineput" class="form-control-label">E-mail</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="email" value="<?php echo $cont ["email"] ?>">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Contato 1</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["contato"] ?>">
                     </div>
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Telefone de contato</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["fone"] ?>">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Contato 2</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["contato2"] ?>">
                     </div>
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Telefone de contato</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["fone2"] ?>">
                     </div>
                     <?php
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["endereco"] ?>">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Cidade</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["cidade"] ?>">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Estado</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["estado"] ?>">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="example-text-input" class="form-control-label">CEP</label>
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont ["cep"] ?>">
                     </div>
                  </div>
               </div>
              </div>
