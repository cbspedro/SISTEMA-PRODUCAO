...
$consulta ="SELECT * FROM clientes ORDER BY nome ASC";
        ...
        <div class="col-12" >
          <div class="card mb-4">
            <div class="card-header pb-0">
                <div class=""style="float:right;" onclick="location='upcliente.php'">
                    <a href="upcliente.php"><i class="
                <?php
  if ($adm == "1") {
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" >
                  ...
                  <tbody>
                    ...
                    <tr onclick="window.location.href='pcliente.php?id=<?php echo $cont ["id"] ?>'">
                      <td>
                      ...
                      <td class="align-middle text-center text-sm"><a href="tel:<?php echo $cont ["fone"] ?>">
                        <span class="badge badge-sm bg-gradient-success" ><?php echo $cont ["fone"] ?></span></a>
                      </td>
