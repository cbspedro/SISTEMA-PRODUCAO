...
$consulta1 ="SELECT * FROM checklist2 WHERE id= '$id'";
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h2> <i class="fa-solid fa-list-check opacity-10 fa-1x text-primary"></i><span > CK<?php echo $id ?></h2></span>
              <h6>Editar serviço realizado </h6>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="card-body">
                  <form role="form" action="checklistload2.php?id=<?php echo $id ?>&os=<?php echo $act ["os"] ?>" method="POST">
                <div class="mb-3">
                  <span class="invalid-feedback"></span>
                  <div class="mb-3">
                  <h6>Serviço realizado</h6>
                  <select name="serv" class="form-control" required >
                    <option disabled selected><?php echo $act ["serv"] ?></option>
