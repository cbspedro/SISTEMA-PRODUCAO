...
include ("../config.php");
$querryclienid ="SELECT cliente FROM checklist WHERE id = '$id'LIMIT 1";
$sera ="SELECT * FROM servs ";
$servcon = $conect->query($sera);
$clienidconect = $conect->query($querryclienid);
while ($clienid1 = $clienidconect->fetch_array()) {
  $clienid = $clienid1 ["cliente"];
}
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h2> <i class="fa-solid fa-list-check opacity-10 fa-1x text-primary"></i><span > CK<?php echo $id ?></h2></span>
              <h6>Adicionar serviço realizado </h6>
               <h6>Técnico responsável pelo serviço: <span style="color:blue"><?php echo $username?></span></h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="card-body">
                  <form role="form" action="checklistload1.php?id=<?php echo $id ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="hidden" name="clienid"  value="<?php echo $clienid;  ?>">
                </div>
