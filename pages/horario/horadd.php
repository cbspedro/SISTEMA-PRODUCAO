      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h2> <i class="fa-solid fa-calendar-days text-primary opacity-10 fa-1x text-primary"></i><span > Horário</h2></span>
              <h6>Adicionar Entrada/Saída </h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="card-body">
                  <form role="form" action="horload.php?" method="POST">
                <div class="mb-3">
                  <span class="invalid-feedback"></span>
                               <h6>Horário</h6>
               <input type="datetime-local" name="hrs"  class="form-control" placeholder="N.Serie" aria-label="Name"value="">
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-success w-100 my-4 mb-2">Finalizar</button>
              </form>
            </div>
          </div>
              </div>
