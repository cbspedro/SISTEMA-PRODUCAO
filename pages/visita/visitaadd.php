      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h2> <i class="fa-solid fa-location-arrow text-primary opacity-10 fa-1x text-primary"></i><span > Visita</h2></span>
              <h6>Adicionar visita realizada </h6>
               <h6>Técnico responsável pela visita: <span style="color:blue"><?php echo $username?></span></h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="card-body">
                  <form role="form" action="visitaload.php?id=<?php echo $id ?>" method="POST">
                <div class="mb-3">
               ...
               <input type="date" name="date"  class="form-control" placeholder="Obs*" aria-label="Name"value="">
