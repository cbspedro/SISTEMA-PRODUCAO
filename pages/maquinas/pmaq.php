      ...
      <div class="row"style="padding-bottom: 100px;" >
          <div class="card mb-4">
            <div class="card-body px-0 pt-0 pb-2">
               ...
               <div class=""style="float:right;" onclick="location='delmaq.php?id=<?php echo $id ?>&clienid=<?php echo $clienid ?>'">
                    <a href="delmaq.php?id=<?php echo $id ?>&clienid=<?php echo $clienid ?>"><i class="
                         <?php while ($cont = $con->fetch_array()) { ?>
                    "aria-hidden="true"></i></a>
                    <a href="delmaq.php?id=<?php echo $id ?>&clienid=<?php echo $clienid ?>"><i class="fa-solid fa-trash-can text-danger opacity-10 fa-2x"></i></a></div>
                <div class="card-body">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input placeholder="Não Cadastrado" readonly="readonly" class="form-control" type="text" value="<?php echo $cont['ns'] ?>">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
