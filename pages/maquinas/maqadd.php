      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h2> <i class="fa-solid fa-desktop text-primary opacity-10 fa-1x text-primary"></i><span > Maquinas</h2></span>
              <h6>Adicionar Maquina </h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="card-body">
                  <form role="form" action="maqload.php?id=<?php echo $id ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <input type="text" name="obs"  class="form-control" placeholder="Obs*" aria-label="Name"value="">
                               ...
                               <h6>N.Serie:</h6>
               <input type="number" name="ns"  class="form-control" placeholder="N.Serie" aria-label="Name"value="">
